...
function displayCourseLink($NumberOfTheCourse, $accessCodeArrayed){
	...
	elseif(isJoined($NumberOfTheCourse, $accessCodeArrayed)){
		if (isJoinable($NumberOfTheCourse, $accessCodeArrayed)) {
			return ' <a class="noUnderline" href="bcaWorkUpload.php?course='.$NumberOfTheCourse.'&challenge='.getNextChallenge($NumberOfTheCourse, $accessCodeArrayed).'"><i class="fas fa-arrow-right"></i> Continuer</a>';
		} else {
